...
__all__ = [('day_ahead_ancillary_services', DayAheadAncillary, '/ancillary-services/day-ahead'),
           ...
           ('load_bid_zonal', LoadBidZonal, '/load/bid/zonal'),
           ('load_iso_forecast', LoadISOForecast, '/load/forecast'),
           ('load_iso_forecast', LoadRealTimeActual, '/load/real-time/actual'),
           ('load_iso_forecast', LoadRealTimeIntegrated, '/load/real-time/integrated'),
