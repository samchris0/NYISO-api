...
def scrape_real_time_lbmp_zonal(daterange):
    """
    This function gets real time lbmp zonal data from the NYISO archive and store requested data
    in the real time lbmp zonal database
