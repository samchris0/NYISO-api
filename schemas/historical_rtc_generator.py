...
class HistoricalRTCGeneratorQuery(Schema):
    ...
    def end_before(self, data, **kwargs):
        if data['end'] > datetime.datetime(2014, 4, 8, 17, 15):
             raise ValidationError('Data not available for this range. Please select a start time at or before than April 8, 1999 17:15')
...
class HistoricalRTCGeneratorValidation(Schema):
